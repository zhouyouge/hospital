...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="name" id="id" class="layui-input" type="text" placeholder="请输入药品ID" autocomplete="off" lay-verify="title">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    function cherkParam(id,name,formid,batch,supplierid,bprice,sprice,totalprice) {
        if (id=="" && id<=0){
            alert("请输入正确的药品ID！");
            return false;
        }
        ...
        if (totalprice=="" && totalprice!=batch*bprice){
            alert("药品总价不正确！");
            return false;
        }
        return true;
